...
class _$ThemeModelImpl implements _ThemeModel {
  const _$ThemeModelImpl({required this.theme, this.value = false});
  ...
  @override
  String toString() {
    return 'ThemeModel(theme: $theme, value: $value)';
  }
...
abstract class _ThemeModel implements ThemeModel {
  const factory _ThemeModel(
      {required final ThemeMode theme, final bool value}) = _$ThemeModelImpl;
